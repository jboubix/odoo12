...
class ir_attachment(models.Model):
        ...
        for record in attachments_for_sync:
            ...
            if res:
                ...
                record.write({
                    "cloud_key": res_id,
                    "cloud_path": path,
                    "datas": False, #to-do: do we really need to write in computed / inversed field??
                    "type": "url",
                    "url": url,
                    "last_sync_datetime": today_now,
                    "name": name,
                    "sync_model_id": sync_model_id and sync_model_id.id or False,
                })
                self._cr.commit()
    ...
    def _update_folders(self):
        ...
        4. Prepare records' structure
           ...
           we take the first
           We rely on the principle: a single folder for one object (model of obhect is not changeable)
    ...
    def _find_folder_by_key(self, parent_key):
        """
        The method to find sync.object or sync.model by key to define attachment Onedrive folder
    ...
    def cron_synchronize_attachments_backward(self):
        ...
        with api.Environment.manage():
            with registry(self._cr.dbname).cursor() as new_cr:
                ...
                Config = new_env['ir.config_parameter'].sudo()
                # 1
                ...
                for folder in folder_ids:
                    ...
                    if client_items is not None:
                        ...
                        to_delete = odoo_items_set - client_items_set
                        to_create = client_items_set - odoo_items_set
